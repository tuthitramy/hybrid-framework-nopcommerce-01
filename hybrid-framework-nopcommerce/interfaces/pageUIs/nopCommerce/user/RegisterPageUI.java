...
public class RegisterPageUI {
	...
	public static final String EXISTING_MAIL_ERROR_MESSAGE = "xpath=//div[@class='message-error validation-summary-errors']";
	public static final String MY_ACCOUNT_BUTTON = "xpath=//a[@class='ico-account']";
